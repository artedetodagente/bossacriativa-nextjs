...
export default function Calendar({
  getDate, getCurrent, mark, changeMonth, getMonth, getYear, changeYear,
}) {
  const now = new Date();
  ...
  useEffect(() => {
    ...
    setYear(changeYear);
    getCurrent({ month: changeMonth, year: changeYear });
  }, [changeMonth]);
...
Calendar.propType = {
  ...
  changeMonth: PropTypes.number,
  changeYear: PropTypes.number,

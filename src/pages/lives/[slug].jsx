...
export default function LiveSlug({ live, menus, links, menusRodape }) {
  return (
    <Page menus={menus} links={links} menusRodape={menusRodape}>
      ...
      <div className={styles.container}>
        ...
        <div className="content">{parse(live?.excerpt || "")}</div>
        <DisqusComments
          post={{
            ...live,
            path: `${process.env.NEXT_PUBLIC_URL}lives/${live?.slug}`,
          }}
        />
      </div>
    </Page>
